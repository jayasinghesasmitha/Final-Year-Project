...
#ifndef VERILATED_VCFU_H_
#define VERILATED_VCFU_H_  // guard

#include "verilated.h"

class Vcfu__Syms;
class Vcfu___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vcfu VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    explicit Vcfu(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vcfu(const char* name = "TOP");
